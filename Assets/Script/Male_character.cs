...
public class Male_character : MonoBehaviour
{
...
//#################저장 및 씬 바꾸기################################
    ...
    public void SaveCurrentDresses(){
        PlayerPrefs.SetInt("malehair",currentHairNumber); //key, value값
        PlayerPrefs.SetInt("malehead",currentHeadNumber);
        PlayerPrefs.SetInt("maletop",currentTopNumber);
        PlayerPrefs.SetInt("maleleg",currentLegNumber);
        //저장 하면 Room으로 간다
    ...
    void LoadSavedDresses(){
        currentHairNumber = PlayerPrefs.GetInt("malehair");
        currentHeadNumber = PlayerPrefs.GetInt("malehead");
        currentTopNumber = PlayerPrefs.GetInt("maletop");
        currentLegNumber = PlayerPrefs.GetInt("maleleg");
    }
